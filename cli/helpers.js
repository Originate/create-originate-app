...
function copyTemplate(srcDir, targetDir) {
    try {
        ...
        exports.log(chalk.cyan("Template copied to:\n  " + chalk.cyan.bold(targetDir)));
    }
    catch (_a) {
        throw new Error(chalk.red("Error copying template from " + srcDir + " to " + targetDir));
    }
}
...
function editPackageJson(appName, targetDir, packageName) {
    ...
    try {
        ...
        exports.log(chalk.blue("Prepared " + filename));
    }
    catch (err) {
