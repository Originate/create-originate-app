...
var logo = function () {
    console.log(chalk_1["default"].magenta.bold.bgGray("\n   _                              \n  / \\ ._ o  _  o ._   _. _|_  _   \n  \\_/ |  | (_| | | | (_|  |_ (/_  \n           __|                    \n                                  \n      Create-Originate-App        \n"));
};
main()
    .then(function (result) {
    helpers_1.log(result);
})["catch"](function (err) {
    console.error(err);
});
function main() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    helpers_1.updateTemplate(appName, targetDir, port);
                    return [2 /*return*/, chalk_1["default"].cyan.bold("Finished")];
            }
        });
    });
}
